...
def load_mnist_data():
    ...
    train_set = MNIST(root=MNIST_DATASET_PATH, train=True, transform=transform, download=True)

    # Loading the test set
    test_set = MNIST(root=MNIST_DATASET_PATH, train=False, transform=transform, download=True)
